...
public class Task_3 {
	    ...
	    private void initialize() {
	        ...
	        btnDot.setForeground(Color.pink);
	        ...
	        btnEqual.setForeground(Color.pink);
	        ...
	        btnXrx.setForeground(Color.pink);
	        btnXrx.setBackground(Color.gray);
	        ...
	        btnCe.setForeground(Color.pink);
	        ...
	        btnEx.setForeground(Color.pink);
	        ...
	        btnSqrt.setForeground(Color.pink);
	        ...
	        btnCos_1.setForeground(Color.pink);
	        btnCos_1.setBackground(Color.gray);
	        ...
	        btnBackSpace.setForeground(Color.pink);
	        ...
	        btnTan_1.setForeground(Color.pink);
	        btnTan_1.setBackground(Color.gray);
	        ...
	        btnPlus.setForeground(Color.pink);
	        ...
	        btnSub.setForeground(Color.pink);
	        ...
	        btnMul.setForeground(Color.pink);
	        ...
	        btnP_1.setForeground(Color.pink);
	        btnP_1.setBackground(Color.gray);
